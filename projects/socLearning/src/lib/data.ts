...
export const certificationsData = [
  {
    ...
    prerequisites: [],
    difficulty: "Beginner",
    skills: ["SOC Operations", "Incident Detection", "Log Analysis", "Alert Triage"],
    validityYears: 3,
    estimatedHours: 20,
    careerImpact: "Entry-level SOC analyst position",
    earnedAt: undefined,
    expiresAt: undefined
  },
  {
    ...
    difficulty: "Advanced",
    skills: ["Network Monitoring", "Threat Detection", "SIEM", "Packet Analysis", "IDS/IPS"],
    validityYears: 3,
    estimatedHours: 40,
    careerImpact: "Senior SOC analyst or Network Security Engineer",
    credentialId: "BTAN-2024-001",
    earnedAt: undefined,
    expiresAt: undefined
  },
  {
    ...
    difficulty: "Expert",
    skills: ["PowerShell", "Automation", "Scripting", "Windows Admin", "Incident Response"],
    validityYears: 4,
    estimatedHours: 50,
    careerImpact: "Security Operations Lead or Automation Engineer",
    earnedAt: undefined,
    expiresAt: undefined
  },
  {
    ...
    difficulty: "Expert",
    skills: ["Threat Hunting", "Advanced Analysis", "Adversary Tactics", "TTPs", "Forensics"],
    validityYears: 3,
    estimatedHours: 45,
    careerImpact: "Threat Hunter or Security Analyst",
    earnedAt: undefined,
    expiresAt: undefined
  },
  {
    ...
    prerequisites: ["SOC Fundamentals"],
    difficulty: "Advanced",
    skills: ["Forensics", "Evidence Collection", "Incident Investigation", "Timeline Analysis"],
    validityYears: 3,
    estimatedHours: 35,
    careerImpact: "Forensics Analyst or Incident Response Specialist",
    earnedAt: undefined,
    expiresAt: undefined
  },
]
